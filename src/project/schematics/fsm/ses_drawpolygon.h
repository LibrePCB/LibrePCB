...
#ifndef PROJECT_SES_DRAWPOLYGON_H
#define PROJECT_SES_DRAWPOLYGON_H
 ...
 */
class SES_DrawPolygon final : public SchematicEditorState
{
        Q_OBJECT
...
#endif // PROJECT_SES_DRAWPOLYGON_H
