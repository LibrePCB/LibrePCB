...
class ProjectLibraryTest : public ::testing::Test
{
    protected:
        ...
        ProjectLibraryTest() {
            ...
            mExistingSymbolFile = QFileInfo(mLibDir.getPathTo(QString("sym/%1/symbol.lp").arg(sym.getUuid().toStr())).toStr());
            ...
            mNewSymbolFile = mLibDir.getPathTo(QString("sym/%1/symbol.lp")
                                               .arg(mNewSymbol->getUuid().toStr())).toStr();
...
TEST_F(ProjectLibraryTest, testRemoveSymbol_SaveToTemporary_AddNewSymbol_SaveToOriginal)
{
    {
        ProjectLibrary lib(mLibDir, false, false);
...
TEST_F(ProjectLibraryTest, testAddNewSymbol_SaveToTemporary_RemoveSymbol_SaveToOriginal_AddSymbol_SaveToTemporary)
{
    {
        ProjectLibrary lib(mLibDir, false, false);
        library::Symbol* sym = getFirstSymbol(lib);
