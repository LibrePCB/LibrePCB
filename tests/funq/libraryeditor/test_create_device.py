...
def test(library_editor, helpers):
    ...
    # Select component
    le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChooseComponentButton"
    ).click()
    category_tree = le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChooseComponentDialogCategoriesTree"
    )
    ...
    components_list = le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChooseComponentDialogComponentsList"
    )
    ...
    le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChooseComponentDialogAcceptButton"
    ).click()

    # Select package
    le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChoosePackageButton"
    ).click()
    category_tree = le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChoosePackageDialogCategoriesTree"
    )
    helpers.wait_for_model_items_count(category_tree, 3)
    category = category_tree.model().items().items[2]
    category_tree.select_item(category)
    packages_list = le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChoosePackageDialogPackagesList"
    )
    ...
    le.widget(
        "libraryEditorNewElementWizardDevicePropertiesChoosePackageDialogAcceptButton"
    ).click()
    ...
    assert (
        le.widget("libraryEditorDeviceAuthorEdit").properties()["text"]
        == "Functional Test"
    )
