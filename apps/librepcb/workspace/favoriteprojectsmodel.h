...
public:
  ...
  explicit FavoriteProjectsModel(Workspace& ws,
                                 QObject* parent = nullptr) noexcept;
  virtual ~FavoriteProjectsModel() noexcept;

  // General Methods
  void add(const FilePath& fp) noexcept;
  void remove(const FilePath& fp) noexcept;
