...
if(EXISTS "${FONTOBENE_SUBMODULE_BASEPATH}" AND NOT UNBUNDLE_FONTOBENE_QT5 AND NOT UNBUNDLE_ALL)
    message(STATUS "Using vendored FontoBeneQt5")

    # Include local submodule
    add_subdirectory(
        "${FONTOBENE_SUBMODULE_BASEPATH}"
        "${CMAKE_BINARY_DIR}/libs/fontobene-qt5"
        EXCLUDE_FROM_ALL
    )
...
if(FONTOBENE_FOUND)
    ...
    target_include_directories(fontobene_qt5 INTERFACE "${FONTOBENE_INCLUDE_DIRS}")
