...
if(EXISTS "${OPTIONAL_SUBMODULE_BASEPATH}")
    ...
    # Disable tests
    set(OPTIONAL_ENABLE_TESTS OFF CACHE BOOL "Build tests of the 'optional' library" FORCE)

    # Include local submodule
    add_subdirectory(
        "${OPTIONAL_SUBMODULE_BASEPATH}"
        "${CMAKE_BINARY_DIR}/libs/optional"
        EXCLUDE_FROM_ALL
    )
...
message(FATAL_ERROR "Did not find Optional library submodule, did you clone recursively?")
