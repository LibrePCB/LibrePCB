...
#
# NOTE: Due to packaging issues with QuaZip 0.x, we only support QuaZip 1.x when unbundling.
#       Using QuaZip 0.9 should work as well, but then you'll have to patch this find script
#       as well as potentially the include paths (quazip -> quazip5) yourself.
#       Or just use the bundled version.
#       See also: https://github.com/LibrePCB/LibrePCB/pull/798#issuecomment-720167363
