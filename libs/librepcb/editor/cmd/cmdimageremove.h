...
#ifndef LIBREPCB_EDITOR_CMDIMAGEREMOVE_H
#define LIBREPCB_EDITOR_CMDIMAGEREMOVE_H
...
/*******************************************************************************
 *  Class CmdImageRemove
 ******************************************************************************/

/**
 * @brief The CmdImageRemove class
 */
class CmdImageRemove final : public UndoCommand {
public:
  // Constructors / Destructor
  CmdImageRemove() = delete;
