...
#ifndef LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_RESULT_H
#define LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_RESULT_H
...
public:
  ...
  ~EagleLibraryImportWizardPage_Result() noexcept override;
