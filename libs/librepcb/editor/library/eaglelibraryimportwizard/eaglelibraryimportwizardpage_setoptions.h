...
#ifndef LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_SETOPTIONS_H
#define LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_SETOPTIONS_H
...
public:
  ...
  ~EagleLibraryImportWizardPage_SetOptions() noexcept override;
