...
#ifndef LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_CHOOSELIBRARY_H
#define LIBREPCB_EDITOR_EAGLELIBRARYIMPORTWIZARDPAGE_CHOOSELIBRARY_H
...
public:
  ...
  ~EagleLibraryImportWizardPage_ChooseLibrary() noexcept override;
