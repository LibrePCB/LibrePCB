...
PackageTab::PackageTab(LibraryEditor& editor, std::unique_ptr<Package> pkg,
  ...
  : LibraryEditorTab(editor, parent),
    ...
    mView(new SlintGraphicsView(SlintGraphicsView::defaultFootprintSceneRect(),
                                this)),
    mOpenGlView(new SlintOpenGlView(OpenGlProjection(), this)),
...
ui::PackageTabData PackageTab::getDerivedUiData() const noexcept {
  ...
  const QColor fgColor = mView3d      ? Qt::black
      : (bgColor.lightnessF() >= 0.5) ? Qt::black
                                      : Qt::white;
...
void PackageTab::activate() noexcept {
  ...
  //         mOpenGlView.data(), &SlintOpenGlView::startSpinning);
  // connect(mOpenGlSceneBuilder.data(), &OpenGlSceneBuilder::finished,
  //         mOpenGlView.data(), &SlintOpenGlView::stopSpinning);
  ...
  //         mOpenGlView.data(),
  //         static_cast<void
  //         (SlintOpenGlView::*)()>(&SlintOpenGlView::update));
