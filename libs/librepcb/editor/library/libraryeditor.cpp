...
ui::LibraryEditorData LibraryEditor::getUiData() const noexcept {
...
void LibraryEditor::setUiData(const ui::LibraryEditorData& data) noexcept {
  Q_UNUSED(data);
}
...
void LibraryEditor::registerTab(WindowTab& tab) noexcept {
  Q_ASSERT(!mRegisteredTabs.contains(&tab));
  mRegisteredTabs.append(&tab);
}

void LibraryEditor::unregisterTab(WindowTab& tab) noexcept {
  Q_ASSERT(mRegisteredTabs.contains(&tab));
