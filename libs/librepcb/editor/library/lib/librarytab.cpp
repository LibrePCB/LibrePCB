...
LibraryTab::LibraryTab(LibraryEditor2& editor, bool wizardMode,
  ...
  connect(&mEditor, &LibraryEditor2::manualModificationsMade, this, [this]() {
...
std::pair<RuleCheckMessageList, QSet<SExpression>> LibraryTab::runChecksImpl() {
