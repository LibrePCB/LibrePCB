 ...
 */
class ComponentGateListModel : public QObject,
...
public:
  ...
  explicit ComponentGateListModel(QObject* parent = nullptr) noexcept;
...
private:
  ui::ComponentGateData createItem(
...
private:
  ...
  QList<ui::ComponentGateData> mItems;
