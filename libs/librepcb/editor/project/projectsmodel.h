...
public:
  ...
  // General Methods
  int getIndexOf(
      std::shared_ptr<librepcb::editor::ProjectEditor2> prj) noexcept;
  std::shared_ptr<ProjectEditor2> getProject(int index) noexcept;
  std::shared_ptr<ProjectEditor2> getProject(const FilePath& fp) noexcept;
  std::shared_ptr<ProjectEditor2> openProject(
      FilePath fp = FilePath()) noexcept;
  void closeProject(int index) noexcept;
  void closeProject(const FilePath& fp) noexcept;
...
private:
  ...
  GuiApplication& mApp;
  QList<std::shared_ptr<ProjectEditor2>> mEditors;
