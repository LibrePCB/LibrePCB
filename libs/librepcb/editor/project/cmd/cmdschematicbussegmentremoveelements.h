...
#ifndef LIBREPCB_EDITOR_CMDSCHEMATICBUSSEGMENTREMOVEELEMENTS_H
#define LIBREPCB_EDITOR_CMDSCHEMATICBUSSEGMENTREMOVEELEMENTS_H
...
/*******************************************************************************
 *  Class CmdSchematicBusSegmentRemoveElements
 ******************************************************************************/

/**
 * @brief The CmdSchematicBusSegmentRemoveElements class
 */
class CmdSchematicBusSegmentRemoveElements final : public UndoCommand {
public:
