...
#ifndef LIBREPCB_EDITOR_CMDSCHEMATICBUSLABELEDIT_H
#define LIBREPCB_EDITOR_CMDSCHEMATICBUSLABELEDIT_H
...
/**
 * @brief The CmdSchematicBusLabelEdit class
 */
class CmdSchematicBusLabelEdit final : public UndoCommand {
public:
