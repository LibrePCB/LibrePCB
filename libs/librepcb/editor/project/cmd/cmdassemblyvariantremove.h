...
#ifndef LIBREPCB_EDITOR_CMDASSEMBLYVARIANTREMOVE_H
#define LIBREPCB_EDITOR_CMDASSEMBLYVARIANTREMOVE_H
...
/**
 * @brief The CmdAssemblyVariantRemove class
 */
class CmdAssemblyVariantRemove final : public UndoCommand {
public:
