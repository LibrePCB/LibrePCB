...
#ifndef LIBREPCB_CORE_NORMS_H
#define LIBREPCB_CORE_NORMS_H
...
inline QString getNormIconPath(const QString& norm) noexcept {
  return QString(":/img/norm/%1.svg").arg(norm.toLower().replace(" ", "_"));
}
