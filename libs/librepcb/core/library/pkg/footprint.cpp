...
std::pair<Point, Point> Footprint::calculateBoundingRect() const noexcept {
  QPainterPath p;
  ...
  // First, take only package outline layer into account.
  ...
  // Only consider courtyard as a last resort.
  if (p.isEmpty()) {
