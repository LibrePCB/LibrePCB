...
#ifndef LIBREPCB_CORE_COMPONENTCATEGORY_H
#define LIBREPCB_CORE_COMPONENTCATEGORY_H
...
public:
  ...
  ~ComponentCategory() noexcept override;
...
private:  // Methods
  ComponentCategory(std::unique_ptr<TransactionalDirectory> directory,
