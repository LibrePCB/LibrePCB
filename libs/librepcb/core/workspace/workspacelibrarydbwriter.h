...
public:
   ...
   */
  int addCorporatePcbProduct(int corpId, const Uuid& uuid, const QString& name,
                             const QString& description, const QUrl& url,
                             int maxLayers);

  /**
   * @brief Add an output job to a previously added corporate
   *
   * @param corpId         ID of the corporate containing this output job.
   ...
   */
  int addCorporateOutputJob(int corpId, WorkspaceLibraryDb::OutputJobKind kind,
