...
CmdDeviceEdit::CmdDeviceEdit(Device& device) noexcept :
    UndoCommand(tr("Edit device properties")), mDevice(device),
    mOldComponentUuid(device.getComponentUuid()), mNewComponentUuid(mOldComponentUuid),
    mOldPackageUuid(device.getPackageUuid()), mNewPackageUuid(mOldPackageUuid)
{
}
