...
ComponentCategoryEditorWidget::ComponentCategoryEditorWidget(const Context& context,
        const FilePath& fp, QWidget* parent) :
    EditorWidgetBase(context, fp, parent), mUi(new Ui::ComponentCategoryEditorWidget)
{
    mUi->setupUi(this);
    ...
    connect(mUi->edtName, &QLineEdit::textEdited, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->edtDescription, &QPlainTextEdit::textChanged, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->edtKeywords, &QLineEdit::textEdited, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->edtAuthor, &QLineEdit::textEdited, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->edtVersion, &QLineEdit::textEdited, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->cbxDeprecated, &QCheckBox::clicked, this, &ComponentCategoryEditorWidget::setDirty);
    connect(mUi->edtParent, &QLineEdit::textChanged, this, &ComponentCategoryEditorWidget::setDirty);
}
