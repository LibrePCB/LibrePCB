                                               ...
                                               private ComponentSymbolVariantList::IF_Observer
{
    ...
    public:
        ...
        // Setters
        void setReferences(UndoStack* undoStack, ComponentSymbolVariantList* variants,
    ...
    private: // Observer
        void listObjectAdded(const ComponentSymbolVariantList& list, int newIndex,
                             const std::shared_ptr<ComponentSymbolVariant>& ptr) noexcept override;
        void listObjectRemoved(const ComponentSymbolVariantList& list, int oldIndex,
                               const std::shared_ptr<ComponentSymbolVariant>& ptr) noexcept override;
    ...
    private: // Methods
        ...
        bool isExistingVariantRow(int row) const noexcept {return row >= 0 && row < mVariantList->count();}
        bool isNewVariantRow(int row) const noexcept {return row == newVariantRow();}
