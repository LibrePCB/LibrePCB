...
SymbolEditorWidget::SymbolEditorWidget(const Context& context, const FilePath& fp,
                                       QWidget* parent) :
    EditorWidgetBase(context, fp, parent), mUi(new Ui::SymbolEditorWidget),
    mGraphicsScene(new GraphicsScene())
{
    ...
    connect(mUi->graphicsView, &GraphicsView::cursorScenePositionChanged,
            this, &SymbolEditorWidget::cursorPositionChanged);
    ...
    connect(mUi->edtName, &QLineEdit::textEdited, this, &SymbolEditorWidget::setDirty);
    connect(mUi->edtDescription, &QPlainTextEdit::textChanged, this, &SymbolEditorWidget::setDirty);
    connect(mUi->edtKeywords, &QLineEdit::textEdited, this, &SymbolEditorWidget::setDirty);
    connect(mUi->edtAuthor, &QLineEdit::textEdited, this, &SymbolEditorWidget::setDirty);
    connect(mUi->edtVersion, &QLineEdit::textEdited, this, &SymbolEditorWidget::setDirty);
    connect(mUi->cbxDeprecated, &QCheckBox::clicked, this, &SymbolEditorWidget::setDirty);
    connect(mCategoriesEditorWidget.data(), &ComponentCategoryListEditorWidget::categoryAdded,
            this, &SymbolEditorWidget::setDirty);
    ...
    SymbolEditorFsm::Context fsmContext {
        *this, *mUndoStack, mContext.layerProvider, *mGraphicsScene, *mUi->graphicsView,
        *mSymbol, *mGraphicsItem, *mCommandToolBarProxy
    };
...
void SymbolEditorWidget::setToolsActionGroup(ExclusiveActionGroup* group) noexcept
{
    if (mToolsActionGroup) {
        disconnect(mFsm.data(), &SymbolEditorFsm::toolChanged,
...
bool SymbolEditorWidget::toolChangeRequested(Tool newTool) noexcept
{
    switch (newTool) {
        ...
        case Tool::ADD_PINS:        return mFsm->processStartAddingSymbolPins();
