 ...
 * @date    2017-02-23
 */
class SymbolEditorState_DrawRect final : public SymbolEditorState_DrawPolygonBase
{
        Q_OBJECT
    ...
    public:
        ...
        SymbolEditorState_DrawRect& operator=(const SymbolEditorState_DrawRect& rhs) = delete;
};
