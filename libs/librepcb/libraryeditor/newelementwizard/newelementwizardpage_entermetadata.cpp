...
NewElementWizardPage_EnterMetadata::NewElementWizardPage_EnterMetadata(NewElementWizardContext& context, QWidget *parent) noexcept :
    QWizardPage(parent), mContext(context), mUi(new Ui::NewElementWizardPage_EnterMetadata)
{
    mUi->setupUi(this);
    connect(mUi->edtName, &QLineEdit::textChanged,
            this, &NewElementWizardPage_EnterMetadata::edtNameTextChanged);
    connect(mUi->edtDescription, &QPlainTextEdit::textChanged,
            this, &NewElementWizardPage_EnterMetadata::edtDescriptionTextChanged);
    connect(mUi->edtKeywords, &QLineEdit::textChanged,
            this, &NewElementWizardPage_EnterMetadata::edtKeywordsTextChanged);
    connect(mUi->edtAuthor, &QLineEdit::textChanged,
           this, &NewElementWizardPage_EnterMetadata::edtAuthorTextChanged);
    connect(mUi->edtVersion, &QLineEdit::textChanged,
            this, &NewElementWizardPage_EnterMetadata::edtVersionTextChanged);
    connect(mUi->edtCategory, &QLineEdit::textChanged,
            this, &NewElementWizardPage_EnterMetadata::edtCategoryTextChanged);
    connect(mUi->btnChooseCategory, &QToolButton::clicked,
            this, &NewElementWizardPage_EnterMetadata::btnChooseCategoryClicked);
}

NewElementWizardPage_EnterMetadata::~NewElementWizardPage_EnterMetadata() noexcept
{
}
...
int NewElementWizardPage_EnterMetadata::nextId() const noexcept
{
    switch (mContext.mElementType) {
        ...
        default: return NewElementWizardContext::ID_None;
    }
}
...
void NewElementWizardPage_EnterMetadata::edtKeywordsTextChanged(const QString& text) noexcept
{
    mContext.mElementKeywords = text.trimmed();
}

void NewElementWizardPage_EnterMetadata::edtAuthorTextChanged(const QString& text) noexcept
{
    ...
    switch (mContext.mElementType) {
        ...
        case NewElementWizardContext::ElementType::Device: {
            ComponentCategoryTreeLabelTextBuilder builder(
                ...
                mContext.getWorkspace().getSettings().getLibLocaleOrder().getLocaleOrder(),
                *mUi->lblCategoryTree);
