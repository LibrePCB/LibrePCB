...
BoardSideSelectorWidget::BoardSideSelectorWidget(QWidget* parent) noexcept :
    QWidget(parent), mBtnTop(new QToolButton(this)), mBtnBottom(new QToolButton(this))
{
    ...
    connect(mBtnTop, &QToolButton::toggled,
            this, &BoardSideSelectorWidget::btnTopToggled);
    connect(mBtnBottom, &QToolButton::toggled,
            this, &BoardSideSelectorWidget::btnBottomToggled);
}
...
FootprintPad::BoardSide BoardSideSelectorWidget::getCurrentBoardSide() const noexcept
{
...
void BoardSideSelectorWidget::setCurrentBoardSide(FootprintPad::BoardSide side) noexcept
{
