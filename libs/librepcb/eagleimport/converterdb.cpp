...
Uuid ConverterDb::getSymbolPinUuid(const Uuid& symbolUuid, const QString& pinName)
{
...
Uuid ConverterDb::getPackagePadUuid(const Uuid& footprintUuid, const QString& padName)
{
...
{
    return getOrCreateUuid("symbolgates_to_symbvaritems", componentUuid.toStr(), gateName);
}

Uuid ConverterDb::getDeviceUuid(const QString& deviceSetName, const QString& deviceName)
{
