...
pub struct ZipArchive(Archive);

/// Create a new [ZipArchive] object from file path
#[no_mangle]
pub extern "C" fn ffi_ziparchive_new_from_file(
  path: &QString,
  err: &mut QString,
) -> *mut ZipArchive {
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_new_from_mem(
  data: &QByteArray,
  err: &mut QString,
) -> *mut ZipArchive {
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_delete(obj: *mut ZipArchive) {
  assert!(!obj.is_null());
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_len(obj: &ZipArchive) -> usize {
  match &obj.0 {
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_name_for_index(
  obj: &mut ZipArchive,
  index: usize,
  name: &mut QString,
  err: &mut QString,
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_read_by_index(
  obj: &mut ZipArchive,
  index: usize,
  buf: &mut QByteArray,
  err: &mut QString,
...
#[no_mangle]
pub extern "C" fn ffi_ziparchive_extract(
  obj: &mut ZipArchive,
  dir: &QString,
) -> bool {
