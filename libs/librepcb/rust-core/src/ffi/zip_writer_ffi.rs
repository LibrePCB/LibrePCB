...
pub struct ZipWriter(Writer);

/// Create a new [ZipWriter] object writing to a file
#[no_mangle]
pub extern "C" fn ffi_zipwriter_new_to_file(
  path: &QString,
  err: &mut QString,
) -> *mut ZipWriter {
...
#[no_mangle]
pub extern "C" fn ffi_zipwriter_new_to_mem(
  data: &mut QByteArray,
) -> *mut ZipWriter {
...
#[no_mangle]
pub extern "C" fn ffi_zipwriter_delete(obj: *mut ZipWriter) {
  assert!(!obj.is_null());
...
#[no_mangle]
pub extern "C" fn ffi_zipwriter_write_file(
  obj: &mut ZipWriter,
  name: &QString,
  data: &QByteArray,
  mode: u32,
...
#[no_mangle]
pub extern "C" fn ffi_zipwriter_finish(
  obj: &mut ZipWriter,
  err: &mut QString,
) -> bool {
