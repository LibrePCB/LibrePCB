...
/**
 * @brief The BoardPickPlaceGenerator class
 */
class BoardPickPlaceGenerator final {
  Q_DECLARE_TR_FUNCTIONS(BoardPickPlaceGenerator)
...
#endif  // LIBREPCB_PROJECT_BOARDPICKPLACEGENERATOR_H
