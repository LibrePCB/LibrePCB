...
class BI_NetSegment final : public BI_Base, public SerializableObject
{
    ...
    public:
        ...
        // NetPoint Methods
        const QList<BI_NetPoint*>& getNetPoints() const noexcept {return mNetPoints;}
        ...
        void addElements(const QList<BI_Via*>& vias, const QList<BI_NetPoint*>& netpoints,
                         const QList<BI_NetLine*>& netlines);
        void removeElements(const QList<BI_Via*>& vias, const QList<BI_NetPoint*>& netpoints,
                            const QList<BI_NetLine*>& netlines);
        ...
        Type_t getType() const noexcept override {return BI_Base::Type_t::NetSegment;}
