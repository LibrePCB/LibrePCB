...
void OriginCrossGraphicsItem::layerColorChanged(const GraphicsLayer& layer, const QColor& newColor) noexcept
{
    Q_UNUSED(layer);
...
void OriginCrossGraphicsItem::layerHighlightColorChanged(const GraphicsLayer& layer, const QColor& newColor) noexcept
{
    Q_UNUSED(layer);
    Q_ASSERT(&layer == mLayer);
...
void OriginCrossGraphicsItem::layerVisibleChanged(const GraphicsLayer& layer, bool newVisible) noexcept
{
    Q_ASSERT(&layer == mLayer);
    Q_UNUSED(newVisible);
