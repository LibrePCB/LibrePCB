...
class AttributeListEditorWidget final : public QWidget
{
    ...
    public:
        ...
        // Getters
        const AttributeList& getAttributeList() const noexcept {return mAttributeList;}
    ...
    private: // Methods
        ...
        void setTableRowContent(int row, const QString& key, const AttributeType& type,
        ...
        void getTableRowContent(int row, QString& key, const AttributeType*& type,
                                QString& value, const AttributeUnit*& unit) const noexcept;
        ...
        bool isExistingAttributeRow(int row) const noexcept {return row >= 0 && row < mAttributeList.count();}
        bool isNewAttributeRow(int row) const noexcept {return row == newAttributeRow();}


    private: // Data
        QTableWidget* mTable;
        AttributeList mAttributeList;
        const Attribute* mSelectedAttribute; ///< do NOT dereference it (could be dangling)!
};
