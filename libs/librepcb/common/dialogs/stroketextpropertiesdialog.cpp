    ...
    mUi(new Ui::StrokeTextPropertiesDialog)
{
    ...
    if (mText.getLetterSpacing().isAuto()) {
        ...
        mUi->spbxLetterSpacingRatio->setValue(mText.getLetterSpacing().getRatio().toPercent());
    }
    if (mText.getLineSpacing().isAuto()) {
        ...
        mUi->spbxLineSpacingRatio->setValue(mText.getLineSpacing().getRatio().toPercent());
    }
...
bool StrokeTextPropertiesDialog::applyChanges() noexcept
{
    try {
        ...
        if (mUi->cbxLetterSpacingAuto->isChecked()) {
            ...
            cmd->setLetterSpacing(StrokeTextSpacing(Ratio::fromPercent(mUi->spbxLetterSpacingRatio->value())), false);
        }
